				...
				<div class="container">
										...
										<ul class="child">
											...
											<li><a href="portfolio-standard-3.html">Portfolios</a>
												<ul>
													...
													<li><a href="portfolio-standard-1.html">Standard 1
															Column</a></li>
													<li><a href="portfolio-standard-2.html">Standard 2
															Columns</a></li>
													<li><a href="portfolio-standard-3.html">Standard 3
															Columns</a></li>
													<li><a href="portfolio-standard-3-alternate.html">Standard
															3 Alternate</a></li>
													<li><a href="portfolio-standard-4.html">Standard 4
															Columns</a></li>
													<li><a href="portfolio-standard-5.html">Standard 5
															Columns</a></li>
					...
					<div class="mini">
						<div class="twelve column alpha omega mini">
							<div class="logo">
								<a href="index.html"><img src="images/logoMINI.png" alt="" /></a>
								<!-- Small Logo -->
							</div>
						</div>
			...
			<div class="slug">
				<div class="container">
					<div class="onebyone-wrapper">
						<div class="preload">
							<center>
								<img src="images/design/preloader.gif" alt="" />
							</center>
						</div>
						<div class="fallback">
						...
						<div class="outer">
							...
							<div class="onebyone hide" id="onebyone">
								...
								<div id="slide-01" class="oneByOne_item"
									data-bg="images/background-1.jpg">
									<div id="left">
										<h3>Introducing:</h3>
										<h1>
											The <strong>Ultimate</strong> Modern Website Solution!
										</h1>
										<h2>Lorem Ipsum Dolar Sit Amet.</h2>
									</div>
									<div class="button">
										<a href="#"><img src="images/button-slider.png" alt="" /></a>
									</div>
									<img src="images/imac-2.png" class="monitor" alt="" /> <img
										src="images/iphone-2.png" class="iphone" alt="" /> <img
										src="images/ipad.png" class="ipad" alt="" />
								</div>

								<div id="slide-02" class="oneByOne_item"
									data-bg="images/background-2.jpg">
									<div id="right">
									...
									<img src="images/ipad.png" class="iphone" alt="" /> <img
										src="images/laptop.png" class="laptop" alt="" /> <img
										src="images/monitor.png" class="monitor" alt="" />
								...
								<div id="slide-03" class="oneByOne_item"
									...
									<div id="left">
										<h3>Enzyme Is A</h3>
										<h1>
											<strong>Unique</strong> and <strong>Clean</strong> Design
										</h1>
									...
									<img src="images/onebyone/1_laptop.png" class="laptop" alt="" />
									<img src="images/onebyone/1_ipad.png" class="ipad" alt="" /> <img
										src="images/onebyone/1_iphone.png" class="iphone" alt="" /> <img
										src="images/onebyone/lens_1.png" class="lens" id="one" alt="" />
									<img src="images/onebyone/lens_2.png" class="lens" id="two"
										alt="" /> <img src="images/onebyone/lens_3.png" class="lens"
										id="three" alt="" />
				...
				<div class="content">
					<div class="container callout">
						...
						<div class="twelve columns">
							<h4>
								Welcome to <span>Enzyme</span> - We Build <span>Professional</span>
								Website Designs!
							</h4>
							<p class="subtitle">Enzyme is a unique and responsive theme.
								Sed volutpat lacinia fringilla.</p>
						</div>

						<div class="four columns button-wrap">
							<div class="wrapper">
								<a href="#" class="medium-button"><span>Buy Enzyme!</span></a>
							</div>
						</div>
					</div>
									...
									<li class="slide">
											...
											<div class="content">
												<div class="border">
													<img class="scale-with-grid"
														src="images/thirds-woman-executives.jpg" alt="" /> <a
														href="images/untouched/woman-executives.jpg"
														class="prettyPhoto zoom"></a> <a class="link"
														href="portfolio-standard-3.html"></a>
												</div>
												<center>
													<h5 class="noline">
														<a href="#">Integer Viverra Ante</a>
													</h5>
												</center>
											</div>
											<div class="shadow"></div>
										...
										<div class="one-third column portfolio-item">
											<div class="content">
												<div class="border">
													<img class="scale-with-grid"
														src="images/thirds-business-model.jpg" alt="" /> <a
														href="images/untouched/business-model.jpg"
														class="prettyPhoto zoom"></a> <a class="link"
														href="portfolio-standard-3.html"></a>
												</div>
												<center>
										...
										<div class="one-third column omega portfolio-item">
											<div class="content">
												<div class="border">
													<img class="scale-with-grid"
														src="images/thirds-woman-laptop.jpg" alt="" /> <a
														class="zoom prettyPhoto"
														href="images/untouched/woman-laptop.jpg"></a> <a
														class="link" href="portfolio-standard-3.html"></a>
												</div>
												<center>
													<h5 class="noline">
														<a href="#">Integer Viverra Ante</a>
										...
										<div class="one-third column omega portfolio-item">
											<div class="content">
												<div class="border">
													<img class="scale-with-grid"
														src="images/thirds-woman-laptop.jpg" alt="" /> <a
														href="images/untouched/woman-laptop.jpg"
														class="zoom prettyPhoto"></a> <a class="link"
														href="portfolio-standard-3.html"></a>
												</div>
												<center>
													<h5 class="noline">
							...
							<div class="callout intext">
								...
								<div class="alpha twelve columns">
									<div class="content">
										...
										<p class="subtitle">Pellentesque nec tortor nunc, id
											adipiscing orci.</p>
									</div>
								</div>
							...
							<ul class="slider carousel" id="clientSlider">
								<li class="slide">
									<div class="client alpha">
										<a href="#"><img id="transparent" src="images/logo1.png"
											alt="" /></a>
									</div>
									<div class="client beta">
										<a href="#"><img id="transparent" src="images/logo2.png"
											alt="" /></a>
									</div>
									<div class="client delta">
										<a href="#"><img id="transparent" src="images/logo3.png"
											alt="" /></a>
									</div>
									<div class="client omega">
										<a href="#"><img id="transparent" src="images/logo4.png"
											alt="" /></a>
									</div>
								</li>
				...
				<div class="content">
					...
					<div class="pattern">
							...
							<div class="sixteen columns">
								<div class="first column alpha">
									...
									<div class="left">
										...
										<h5>Enzyme</h5>
										<p>Integer eu ante in arcu viverra vehicula donec tempus
											consequat faucibus. Donec ne thomp nibh egestas suscipit.
											Donec sed lacus at massa lorem pharetra id eleifend leo.</p>
										<p class="extra">Pellentesque quis felis neque, id
											adipiscing nunc. Ipsum elit, vitae tempus tellus. Class
											aptent taciti sociosq desis torquent per conubia nostra, per
											inceptos himenae dolar eget lacinia sem.</p>
									</div>
								</div>
								<div class="column ct">
									<h5>Recent Tweets:</h5>
									<ul class="twitter" id="twitter_update_list">
										<li>Twitter is loading</li>
									</ul>
								</div>
						...
						<div class="sixteen columns alpha omega">
							<div class="foot-nav-bg"></div>
							<div class="foot-nav">
								<div class="copy">Coptyright © 2011-2012 Enzyme. By
									Empirical Themes - Remove upon purchase</div>
								<div class="nav">
									<a href="#">Home</a> <a href="#">Portfolio</a> <a href="#">Contact
										Us</a> <a href="#">Terms of Use</a> <a href="#">Privacy</a>
								</div>
							</div>
						</div>
					</div>
