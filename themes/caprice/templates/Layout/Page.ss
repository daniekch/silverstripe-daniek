...
<div id="slider">
    ...
    <ul class="slides">
    	<li><img src="{$ThemeDir}/images/art/slide1.jpg" alt=""/></li>
    	<li><img src="{$ThemeDir}/images/art/slide2.jpg" alt=""/></li>
    	<li><img src="{$ThemeDir}/images/art/slide3.jpg" alt=""/></li>
    	<li><img src="{$ThemeDir}/images/art/slide4.jpg" alt=""/></li>
    </ul>
  </div>
...
<div class="one-half">
	<h3><img src="{$ThemeDir}/images/icon-web.png" alt="" />Web Design</h3>
...
<div class="one-half last">
	<h3><img src="{$ThemeDir}/images/icon-illus.png" alt="" />Illustration</h3>
...
<div class="one-half">
	<h3><img src="{$ThemeDir}/images/icon-motion.png" alt="" />Motion Graphic</h3>
...
<div class="one-half last">
	<h3><img src="{$ThemeDir}/images/icon-pack.png" alt="" />Package Design</h3>
...
<div id="carousel-scroll"><a href="#" id="prev"></a><a href="#" id="next"></a></div>
	<ul>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p1.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p2.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p3.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p4.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p5.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p6.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p7.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p8.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p9.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p10.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p11.jpg" alt="" /> </a> </li>
		<li> <a href="#"> <span class="overlay details"></span><img src="{$ThemeDir}/images/art/p12.jpg" alt="" /> </a> </li>
	</ul>
</div>
...
<div id="footer">
	<div class="footer-box one-third">
		...
		<ul class="popular-posts">
			<li>
				<a href="#"><img src="{$ThemeDir}/images/art/s1.jpg" alt="" /></a>
				<h5><a href="#">Dolor Commodo Consectetur</a></h5>
				<span>26 Aug 2011 | <a href="#">21 Comments</a></span>
			</li>
			
			<li>
				<a href="#"><img src="{$ThemeDir}/images/art/s2.jpg" alt="" /></a>
				<h5><a href="#">Dolor Commodo Consectetur</a></h5>
				<span>26 Aug 2011 | <a href="#">21 Comments</a></span>
			</li>
			
			<li>
				<a href="#"><img src="{$ThemeDir}/images/art/s3.jpg" alt="" /></a>
				<h5><a href="#">Dolor Commodo Consectetur</a></h5>
				<span>26 Aug 2011 | <a href="#">21 Comments</a></span>
			</li>
