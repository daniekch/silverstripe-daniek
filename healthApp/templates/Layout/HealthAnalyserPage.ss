<% require javascript('https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.3.0/Chart.bundle.min.js') %>
			        ...
			        <div class="media">
			            <div class="parrent pull-left">
			                <ul class="nav nav-tabs nav-stacked">
			                    ...
			                    <li class=""><a href="#tab3" data-toggle="tab" class="analistic-03">Schritte</a></li>
			                </ul>
			            </div>
