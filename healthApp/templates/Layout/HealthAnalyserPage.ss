    ...
    <div class="container">
    	<div class="row">
	    	...
	    	<div class="col-xs-12 col-sm-10">
		        ...
		        <% else %>
		        	<div class="warning">Sie haben noch keine Daten importiert. Bitte importiere sie die Daten in ihrem <a href="$LinkToHealthProfilPage" title="Profil bearbeiten">Profil</a>.</div>
		        <% end_if %>
			</div>
    	</div>
	</div>
